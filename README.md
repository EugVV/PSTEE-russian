...
-------------------------------------------------------------
На основе перевода из Arcane Pack. Компонент «Russian translation of menu buttons» мода заменяет официальные рендеры кнопок и иконок характеристиков на нарисованные Apxu (можно не устанавливать, если официальные нравятся больше, шрифт и тут и там использовался одинаковый, надписи тоже идентичны).
